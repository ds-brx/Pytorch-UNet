...
## change path to your dir
dir_img = Path('/Users/breenda/Desktop/Pytorch-UNet/data/imgs/')
dir_mask = Path('/Users/breenda/Desktop/Pytorch-UNet/data/masks/')
dir_checkpoint = Path('/Users/breenda/Desktop/Pytorch-UNet/checkpoints/')
        ...
        with tqdm(total=n_train, desc='Epoch {}/{}'.format(epoch + 1,epochs), unit='img') as pbar:
            for batch in train_loader:
                ...
                assert images.shape[1] == net.n_channels, \
                    ...
                    'the images are loaded correctly.'.format(net.n_channels, images.shape)
                ...
                if division_step > 0:
                    if global_step % division_step == 0:
                        for tag, _ in net.named_parameters():
                            tag = tag.replace('/', '.')
